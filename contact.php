...
<body>
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card">
                    <img src="images/socialmedia.png" alt="image">
                     ...
                     <a href="https://twitter.com/TheMarvelvsDC?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank"><em class="fa fa-twitter-square" style="color:#00acee; font-size:40px" ></em> Twitter </a>
                </div>
        ...
        <div class="rightcolumn">
                <div class="contact">
                    ...
                    Or Email us on : <em class="fa fa-envelope" style=" font-size:15px"> </em> nixon@gmail.com
 ...
 <div class="footer">
        ...
        <a href="https://www.google.com/maps/d/edit?mid=1HqXfCxWrmokna6IfjvKOA2PTFogndeJ1&usp=sharing" target="_blank"><em class="fa fa-map-marker" style=" font-size:15px"> </em> No. 7 Ridgewayplace, Colombo 04 <br> </a>
            ...
            <a href="mailto:nixon@gmail.com" target="_blank">  <em class="fa fa-envelope" style=" font-size:15px"></em> dc.vs.marvel000@gmail.com  </a>        </div>

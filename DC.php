...
<TITLE>Nixon - TUTORIAL</TITLE>
<style>
    body {
         background-image: url("images/DC PAGE.png");
...
<div class="comics">dc</div>
 
<div id="product-grid">
	
            <?php
            $product_array = $db_handle->runQuery("SELECT * FROM DC ORDER BY id ASC");

    ...
    <a class="logo" href="index.php"> <img src="images/logo.jpg" alt="image">  </a>
            ...
            <nav class="header-left">
                <a  href="index.php">Home</a>
                    <div class="dropdown">
                <a class="active" href="MARVEL.php"><strong>SOFTWARE</a></strong>
...
<div class="comics"> MARVEL</div>
 
<div id="comics-grid">
	
            <?php
            $product_array = $db_handle->runQuery("SELECT * FROM MARVEL ORDER BY id ASC");
